...
public class TopStudentsControllerTest {
    ...
    @BeforeEach
    void setUp() {
        topStudentsController = new TopStudentsController(studentRestController, studentRepository, classRepository);
    }
    ...
    public void test_getTopMaleStudents() {
        ...
        Student class7A_student1 = new StudentBuilder()
                .setFirstName("Liam")
                .setLastName("Heß")
                .setFemale(false)
        ...
        Student class7A_student2 = new StudentBuilder()
                ...
                .setSchoolClass(class7A)
                .createStudent();
        Student class7A_student3 = new StudentBuilder()
                .setFirstName("Lucy")
                .setLastName("Schmitz")
                .setFemale(true)
                .setSchoolClass(class7A)
        ...
        Student class7A_student4 = new StudentBuilder()
                ...
                .setSchoolClass(class7A)
                .createStudent();
        Student class7A_student5 = new StudentBuilder()
                .setFirstName("Lisa")
        ...
        Student class7B_student1 = new StudentBuilder()
                .setFirstName("Marius")
                .setLastName("Runkel")
                .setFemale(false)
                .setSchoolClass(class7B)
                .createStudent();
        Student class7B_student2 = new StudentBuilder()
        ...
        Student class7B_student4 = new StudentBuilder()
                ...
                .setSchoolClass(class7B)
                .createStudent();
        Student class7B_student5 = new StudentBuilder()
